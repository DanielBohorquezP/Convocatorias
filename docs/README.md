...
Especificación funcional y técnica del MVP **v4** (septiembre 2026). Es la fuente de verdad del producto: si el código y estos documentos se contradicen, gana el documento (o se actualiza el documento explícitamente).
...
| [`01-casos-de-uso.md`](01-casos-de-uso.md) | CU-01 a CU-37 con actor, precondiciones, flujo principal, flujos alternos y postcondiciones. Ciclos de vida de cada objeto | Antes de implementar una pantalla o un flujo |
| [`02-requerimientos-funcionales.md`](02-requerimientos-funcionales.md) | RF-01 a RF-63 con prioridad MoSCoW y trazabilidad al caso de uso | Para saber qué debe hacer exactamente el sistema |
| [`03-requerimientos-no-funcionales.md`](03-requerimientos-no-funcionales.md) | RNF-01 a RNF-24 con criterio de verificación, y las 22 reglas de negocio | Seguridad, rendimiento, veracidad de la IA, validaciones |
...
| [`07-modelo-de-negocio.md`](07-modelo-de-negocio.md) | Planes, precios en COP, créditos de IA, benchmark y análisis competitivo | Pantallas de suscripción y cupos |
